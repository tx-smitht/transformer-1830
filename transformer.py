...
# - Larger block_size allows the model to capture longer-range dependencies
# - Higher n_embd, n_head, and n_layer increase model capacity but require more compute
